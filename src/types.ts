...
export declare interface ScalapaySDK {
  postV2Orders(payload: ScalapayCreateOrderInput): Promise<{ data: PostV2OrdersResponse }>
  postV2PaymentsCapture(payload: ScalapayCaptureOrderInput): Promise<{ data: PostV2PaymentsCaptureResponse }>
